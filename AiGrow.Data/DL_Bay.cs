...
namespace AiGrow.Data
{
    public class DL_Bay
    {
        ...
        {
            return MySQLHelper.ExecuteDataTable(DBConnection.connectionString, System.Data.CommandType.Text, "SELECT bay_unique_id AS unique_id, bay_id AS id FROM bay");
        }
    }
}
