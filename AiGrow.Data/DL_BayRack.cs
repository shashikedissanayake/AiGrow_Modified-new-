...
namespace AiGrow.Data
{
    public class DL_BayRack
    {
        ...
        {
            return MySQLHelper.ExecuteDataTable(DBConnection.connectionString, System.Data.CommandType.Text, "SELECT rack_unique_id AS unique_id, rack_id AS id FROM rack");
        }
    }
}
