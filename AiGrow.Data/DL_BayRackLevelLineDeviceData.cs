...
namespace AiGrow.Data
{
    public class DL_BayRackLevelLineDeviceData
    {
        ...
        public DataTable selectDataSet(string device)
        {
            ...
            return MySQLHelper.ExecuteDataTable(DBConnection.connectionString, System.Data.CommandType.Text, "SELECT lldd.received_time, lldd.data FROM level_line_device_data lldd WHERE lldd.device_unique_id = @device_id", para);
        }
    }
}
