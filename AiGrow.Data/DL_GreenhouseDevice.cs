...
namespace AiGrow.Data
{
    public class DL_GreenhouseDevice
    {
        ...
        public bool doesDeviceExist(string device)
        {
            ...
            int count = MySQLHelper.ExecuteDataTable(DBConnection.connectionString, System.Data.CommandType.Text, "SELECT * FROM `greenhouse_device` WHERE greenhouse_device_unique_id = @device_id", para).Rows.Count;
            return count >= 1;
        }
        ...
        public DataTable selectAllDevices(string id)
        {
            ...
            return MySQLHelper.ExecuteDataTable(DBConnection.connectionString, System.Data.CommandType.Text, "SELECT greenhouse_device_unique_id, device_id FROM bay_line_device bld WHERE bld.bay_line_id = @device_id", para);
        }
    }
}
